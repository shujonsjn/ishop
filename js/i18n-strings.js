window.__i18nStrings = {
    ...
    'detail.review_login_hint': { bn: 'রিভিউ দিতে লগইন করুন', en: 'Login to write a review' },
    'detail.review_already': { bn: 'আপনি ইতিমধ্যে রিভিউ দিয়েছেন', en: 'You have already reviewed this product' },
    'detail.review_purchase_hint': { bn: 'শুধুমাত্র কেনা পণ্যের রিভিউ দিতে পারবেন', en: 'You can only review products you have purchased' },
    'detail.review_edit': { bn: 'এডিট', en: 'Edit' },
    'detail.review_delete': { bn: 'মুছুন', en: 'Delete' },
    'detail.review_save': { bn: 'সংরক্ষণ', en: 'Save' },
    'detail.review_cancel': { bn: 'বাতিল', en: 'Cancel' },
    'detail.review_delete_confirm': { bn: 'আপনি কি নিশ্চিত এই রিভিউ মুছে ফেলতে চান?', en: 'Are you sure you want to delete this review?' },
    ...
    'detail.share': { bn: 'শেয়ার করুন', en: 'Share' },
    ...
    'orders.review': { bn: 'রিভিউ দিন', en: 'Review' },
    ...
    'toast.review_updated': { bn: 'রিভিউ আপডেট হয়েছে!', en: 'Review updated!' },
    'toast.review_deleted': { bn: 'রিভিউ মুছে ফেলা হয়েছে!', en: 'Review deleted!' },
